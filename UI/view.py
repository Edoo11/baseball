...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddAnno = ft.Dropdown(label="Anno", width=200, alignment=ft.alignment.top_left , on_change=self._controller.getSquadreAnnoController)
        self._controller.caricaDDanni()
